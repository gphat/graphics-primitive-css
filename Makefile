...
# These definitions are from config.sh (via /opt/local/lib/perl5/5.10.0/darwin-thread-multi-2level/Config.pm).
...
SITEARCHEXP = /opt/local/lib/perl5/site_perl/5.10.0/darwin-thread-multi-2level
SO = dylib
VENDORARCHEXP = /opt/local/lib/perl5/vendor_perl/5.10.0/darwin-thread-multi-2level
...
INSTALLARCHLIB = /opt/local/lib/perl5/5.10.0/darwin-thread-multi-2level
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /opt/local/lib/perl5/site_perl/5.10.0/darwin-thread-multi-2level
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = /opt/local/lib/perl5/vendor_perl/5.10.0/darwin-thread-multi-2level
...
PERL_LIB =
PERL_ARCHLIB = /opt/local/lib/perl5/5.10.0/darwin-thread-multi-2level
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = /opt/local/lib/perl5/5.10.0/darwin-thread-multi-2level/CORE
...
INST_LIBDIR      = $(INST_LIB)/Graphics/Primitive
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Graphics/Primitive
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Graphics::Color" VERSION="0.23" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Graphics::Primitive" VERSION="0.44" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Moose::" VERSION="0.87" />' >> $(DISTNAME).ppd
