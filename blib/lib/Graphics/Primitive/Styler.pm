package Graphics::Primitive::Styler;
use Moose;
...
Graphics::Primitive::Styler - Styles for Graphics::Primitive documents
...
Graphics::Primitive::Styler allows you to change the various attributes of a
Graphics::Primitive document using CSS.

=head1 SELECTORS

Graphics::Primitive::Styler currently supports a class (.classname)
...
Graphics::Primitive::Styler supports the following properties in the following
ways.
